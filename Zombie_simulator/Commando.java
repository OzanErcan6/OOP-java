...
public class Commando extends SimulationObject {
    ...
    public void step(SimulationController controller) {
        ...
        if (!controller.getBullets().isEmpty())
            return;
        ...
        if (this.state == SoldierState.SHOOTING) {
            ...
            if (distance <= this.shootingRange) {
                Position newDirection = new Position(closerZombie.getPosition().getX() - this.getPosition().getX(),
                        closerZombie.getPosition().getY() - this.getPosition().getY());
        ...
        if (this.state == SoldierState.SEARCHING) {
            ...
            if (closeZombie != null) {
                distance = this.getPosition().distance(closeZombie.getPosition());
                Position newDirection = new Position(closeZombie.getPosition().getX() - this.getPosition().getX(),
                        closeZombie.getPosition().getY() - this.getPosition().getY());
                newDirection.normalize();
